...
function DebugInspector(divid, diagram, options) {
  ...
  */
  ...
  div.className = "debug-inspector-container";
  var chooser = document.createElement("select");
  div.appendChild(chooser);
  var mainDiv = document.createElement("div");
  mainDiv.className = "debug-inspector";
  div.appendChild(mainDiv);
  var acceptResetDiv = document.createElement("div");
  acceptResetDiv.className = "debug-inspector-button-container";
...
DebugInspector.createSection = function(name) {
  ...
  div.className = "debug-inspector-section";
...
View.prototype.makeInspectorGroup = function() {
  var div = document.createElement("div");
  div.className = "debug-inspector-group";
  var label = document.createElement("label");
  label.textContent = "LABEL";
  label.className = "debug-property-name";

  var appendElement = label;
  if (this.isNullable()) {
    div.className += " debug-inspector-nullable";
...
View.prototype.nFieldHTMLInit = function(fields) {
  ...
  for (var i = 0; i < fields.length; i++) {
    ...
    label.className = "debug-inspector-n-field-label";

    var input = document.createElement("input");
    input.className = "debug-input-short";
    inputs.push(input);
...
View.prototype.initialize = function() {
  ...
  switch (type) {
    ...
    case "boolean":
      ...
      var input = document.createElement("input");
      input.type = "checkbox";
      input.className = "debug-inspector-boolean-control";
      var label = div.children[0];
      label.className = "debug-make-inline";
    ...
    default:
      ...
      var input = document.createElement("input");
      input.type = "text";
      if (this.getType() === "number") input.className += " debug-right-align";
      input.className += " debug-input-long";
  ...
  switch (type) {
    ...
    case "Brush":
      ...
      if (typeof val === "string" || val.type === go.Brush.Solid) {
        ...
        var options = {
          replacerClassName: 'debug-spectrum-control',
          color: colorString,
          showAlpha: true,
          showInput: true,
